  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20">
      <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Opportunities don't wait !!</h1>
        <div className="h-1 w-20 bg-indigo-500 rounded"></div>
      </div>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-400 text-opacity-90">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse architecto, ullam ab reprehenderit beatae odit nostrum, amet cumque officia excepturi, quia quo libero est voluptatum modi quos explicabo nisi atque qui hic officiis..</p>
    </div>
